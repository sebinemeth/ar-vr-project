...
IL2CPP_EXTERN_C String_t* _stringLiteral4909ECA13A4A7FB51EA65374896091CC531CAD58;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PointCloudParser_PointCloudChanged_mC95039EBBE5FEBB2EA55B4E3B851C84F19933AC6 (PointCloudParser_t18887F5D4BBB99935E93ABE37DF1597ADBA5EED3* __this, ARPointCloudChangedEventArgs_t7DE4CA4D30D369496221061F89CC4BF84E42CC1B ___obj0, const RuntimeMethod* method) 
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		...
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteral4909ECA13A4A7FB51EA65374896091CC531CAD58);
		s_Il2CppMethodInitialized = true;
	}
	...
	Enumerator_t8FB18A95FE66623BA79D1603327BD092F7242F76 V_3;
	memset((&V_3), 0, sizeof(V_3));
	Enumerator_tE96151B77620FFB69CA6D7FFE93A6563A33F8308 V_4;
	memset((&V_4), 0, sizeof(V_4));
	Nullable_1_t8E36DA714556A75295117FA891459FC09EA64AA4 V_5;
...
FINALLY_006c:
			{// begin finally (depth: 1)
				Enumerator_Dispose_m25AECF8298BD8158D0FDCFB35FB1F1F63166F76F((&V_3), Enumerator_Dispose_m25AECF8298BD8158D0FDCFB35FB1F1F63166F76F_RuntimeMethod_var);
				return;
			}// end finally (depth: 1)
		});
		try
...
IL_0015_1:
			{
				...
				L_3 = Enumerator_get_Current_m878F5264E908AFA4C928136147942D85E6C54BA8_inline((&V_3), Enumerator_get_Current_m878F5264E908AFA4C928136147942D85E6C54BA8_RuntimeMethod_var);
				...
				L_5 = Nullable_1_get_Value_m0B786A1358FF6C1E2BB187D6D8354A155148928C((&V_5), Nullable_1_get_Value_m0B786A1358FF6C1E2BB187D6D8354A155148928C_RuntimeMethod_var);
				V_6 = L_5;
				Enumerator_tE96151B77620FFB69CA6D7FFE93A6563A33F8308 L_6;
				L_6 = NativeSlice_1_GetEnumerator_mF03F6157B3E1B16E162BD931D5B962AB48DC6724((&V_6), NativeSlice_1_GetEnumerator_mF03F6157B3E1B16E162BD931D5B962AB48DC6724_RuntimeMethod_var);
				V_4 = L_6;
			}
			{
				auto __finallyBlock = il2cpp::utils::Finally([&]
...
FINALLY_0053_1:
					{// begin finally (depth: 2)
						Enumerator_Dispose_m1FC3B252477A63C80FD964A9D560C1C516C656F9((&V_4), Enumerator_Dispose_m1FC3B252477A63C80FD964A9D560C1C516C656F9_RuntimeMethod_var);
						return;
					}// end finally (depth: 2)
				});
				try
...
IL_0037_2:
					{
						...
						L_7 = Enumerator_get_Current_m8F5AFFF0F427D0327051651D964DF450A298D470((&V_4), Enumerator_get_Current_m8F5AFFF0F427D0327051651D964DF450A298D470_RuntimeMethod_var);
						V_7 = L_7;
						// addedPoints.Add(pos);
...
IL_0048_2:
					{
						// foreach (var pos in pointCloud.positions)
						bool L_10;
						L_10 = Enumerator_MoveNext_mF10E25D26D376437F7CC00824A93C0A993BBF3DF((&V_4), Enumerator_MoveNext_mF10E25D26D376437F7CC00824A93C0A993BBF3DF_RuntimeMethod_var);
						if (L_10)
						{
							goto IL_0037_2;
						}
...
IL_0061_1:
			{
				// foreach (var pointCloud in obj.added)
				bool L_11;
				L_11 = Enumerator_MoveNext_mC331741D586B09E1E2313DB28ABAB1E971C231EC((&V_3), Enumerator_MoveNext_mC331741D586B09E1E2313DB28ABAB1E971C231EC_RuntimeMethod_var);
				if (L_11)
				{
					goto IL_0015_1;
				}
...
IL_008f_1:
			{
				...
				L_15 = Enumerator_get_Current_m878F5264E908AFA4C928136147942D85E6C54BA8_inline((&V_3), Enumerator_get_Current_m878F5264E908AFA4C928136147942D85E6C54BA8_RuntimeMethod_var);
				// foreach (var pos in pointCloud.positions)
				NullCheck(L_15);
				...
				L_17 = Nullable_1_get_Value_m0B786A1358FF6C1E2BB187D6D8354A155148928C((&V_5), Nullable_1_get_Value_m0B786A1358FF6C1E2BB187D6D8354A155148928C_RuntimeMethod_var);
				V_6 = L_17;
				Enumerator_tE96151B77620FFB69CA6D7FFE93A6563A33F8308 L_18;
				L_18 = NativeSlice_1_GetEnumerator_mF03F6157B3E1B16E162BD931D5B962AB48DC6724((&V_6), NativeSlice_1_GetEnumerator_mF03F6157B3E1B16E162BD931D5B962AB48DC6724_RuntimeMethod_var);
				V_4 = L_18;
			}
			{
				auto __finallyBlock = il2cpp::utils::Finally([&]
...
IL_00b1_2:
					{
						...
						L_19 = Enumerator_get_Current_m8F5AFFF0F427D0327051651D964DF450A298D470((&V_4), Enumerator_get_Current_m8F5AFFF0F427D0327051651D964DF450A298D470_RuntimeMethod_var);
						V_8 = L_19;
...
IL_00c2_2:
					{
						// foreach (var pos in pointCloud.positions)
						bool L_22;
						L_22 = Enumerator_MoveNext_mF10E25D26D376437F7CC00824A93C0A993BBF3DF((&V_4), Enumerator_MoveNext_mF10E25D26D376437F7CC00824A93C0A993BBF3DF_RuntimeMethod_var);
						if (L_22)
						{
							goto IL_00b1_2;
						}
...
IL_00db_1:
			{
				// foreach (var pointCloud in obj.updated)
				bool L_23;
				L_23 = Enumerator_MoveNext_mC331741D586B09E1E2313DB28ABAB1E971C231EC((&V_3), Enumerator_MoveNext_mC331741D586B09E1E2313DB28ABAB1E971C231EC_RuntimeMethod_var);
				if (L_23)
				{
					goto IL_008f_1;
				}
...
IL_00f4:
	{
		...
		L_27 = List_1_get_Item_m8F2E15FC96DA75186C51228128A0660709E4E810(L_24, ((int32_t)il2cpp_codegen_subtract(L_26, 1)), List_1_get_Item_m8F2E15FC96DA75186C51228128A0660709E4E810_RuntimeMethod_var);
		V_2 = L_27;
		// countStr.text = $"{updatedPoints.Count} [{last.x} {last.y} {last.z}]";
		Text_tD60B2346DAA6666BF0D822FF607F0B220C2B9E62* L_28 = __this->___countStr_6;
		...
		String_t* L_50;
		L_50 = String_Format_m918500C1EFB475181349A79989BB79BB36102894(_stringLiteral4909ECA13A4A7FB51EA65374896091CC531CAD58, L_45, NULL);
		NullCheck(L_28);
		VirtualActionInvoker1< String_t* >::Invoke(75 /* System.Void UnityEngine.UI.Text::set_text(System.String) */, L_28, L_50);
		// }
		return;
	}
}
